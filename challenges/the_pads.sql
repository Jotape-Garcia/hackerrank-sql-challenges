...
/*
    Exercise Link: https://www.hackerrank.com/challenges/the-pads/problem?isFullScreen=true
    ...
    AnActorName(A), ADoctorName(D), AProfessorName(P), and ASingerName(S). Query the number of ocurrences 
    of each occupation in OCCUPATIONS. Sort the occurrences in ascending order, and output them in the 
    following format:
